...
pets = {
    ...
    'SILVERFISH': {
        ...
        'stats': {
			...
			'True Defense': lambda lvl: lvl * 0.15
        },
        'type': 'mining',
    ...
    'PIGMAN': {
        ...
        }, # lvl * 0.4 damage and lvl * 0.25 strength to Pigman Sword (All), Additional Damage lvl * 0.25% to mobs above lvl 100 (Slayers, Legendary)
        'type': 'combat',
    ...
    'LION': {
        ...
        'stats': {
            ...
            'strength': lambda lvl: lvl // 2
        }, # First Strike lvl * 0.5% (Zealots, All), # lvl * 0.3% weapon damage tooltip when hitting mobs below lvl 80 (Zealots, All)
        'type': 'foraging',
    ...
    'MAGMA_CUBE': {
        ...
        }, # Additional Damage lvl * 0.25% to slimes (All), Ember Armor Stats boost lvl * 1% (Legendary)
        'type': 'combat',
...
runecrafting_xp_requirements = [
	50, 150, 275, 435, 635, 885, 1200, 1600, 2100, 2725, 3510,
	4510, 5760, 7360, 9360, 11825, 14950, 18950, 23950, 30150,
	37950, 47750, 59950, 75250
] # Shamelessly stolen from sky.lea.moe

minion_slot_requirements = [
	0, 0, 0, 0, 0, 5, 15, 30, 50, 75, 100,
...
] # every level after 2.5 mil needs 3mil
