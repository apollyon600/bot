...
{percent_line}```'''
    ...
    async def optimize_talismans(self, message, *args):
        ...
        if len(player.weapons) == 0:
            await channel.send(
                f'{user.mention}, you have `no weapons` in your inventory. If you have any items in your inventory or backpacks with no rarity, this will stop sbs from finding your weapons. If you do not have any, DM uwu your profile.')
            return
    ...
    async def view_missing_talismans(self, message, *args):
        ...
        inactive = [talisman for talisman in player.talismans if
                    talisman.active is False and talisman.internal_name != 'PERSONAL_COMPACTOR_(4|5|6)?000']
